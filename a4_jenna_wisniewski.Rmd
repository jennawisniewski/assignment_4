...
```{r}
##Creating exploratory graphs to see if the weights for male, female, and N/A are normally distributed so that I may perfrom statistical tests with them. 
...
##The data appears to be fairly normally distributed 
```
